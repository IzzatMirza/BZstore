...
export default function clothe30() {
  return (
    <>
    <div className='container '>
  <div className='row'>
<div className='rounded col-12 col-md-6 col-sm-6 mt-3'>
<img src='c30i2.jpg' className='responsive'></img>
</div>


<div className='rounded col-12 col-md-6 col-sm-6 mt-3'>
<img src='c30i3.jpg' className='responsive'></img>

</div>

<div className='rounded col-12 col-md-6 col-sm-6 mt-3'>
<img src='c30i4.jpg' className='responsive'></img>
...
<li>
Product Feature: Fancy, Casual
</li>
<li>
Available Sizes: 35, 36, 37, 38, 39, 40, 41, 42
</li>
<li>
Package Includes: 1 x Slippers
</li>



{/* Product Code: MZ659200283FCPK */}
  ...
  <li><span className='text-danger'>Return Within 7 days</span>
    ...
    <h3><span className='text-danger'>Product ID</span>: 99230</h3>
