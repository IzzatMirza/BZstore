...
export default function Shop27() {
  return (
    <>
    <div className='container '>
      <div className='row'>
    <div className='rounded col-12 col-md-6 col-sm-6 mt-3'>
    <img src='s27i1.jpg' className='responsive'></img>
    </div>
...
•  Shirt Chest: 22 Inches
  ...
  {/* Product Code: MZ1204200030ALINOESGSN */}

  <li><span className='text-danger'>Return Within 7 days</span>
                    
                    </li>
                  
    <h3><span className='text-danger'>Product ID</span>: 99027</h3>
