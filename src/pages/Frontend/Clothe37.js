...
export default function clothe37() {
  return (
    <>
    <div className='container '>
  <div className='row'>
<div className='rounded col-12 col-md-6 col-sm-6 mt-3'>
<img src='c37i2.jpg' className='responsive'></img>
</div>


<div className='rounded col-12 col-md-6 col-sm-6 mt-3'>
<img src='c37i3.jpg' className='responsive'></img>

</div>

<div className='rounded col-12 col-md-6 col-sm-6 mt-3'>
<img src='c37i4.jpg' className='responsive'></img>
...
<li>
Material: PU Fabric, PVC Sole
</li>
<li>
Product Type: Women's Khussa
</li>
<li>
Pattern: Embroidered
</li>
...
<li>
Product Feature: Comfortable, Handmade, Durable
</li>

{/* Product Code: MZ30400206INNHB */}
  ...
  <li><span className='text-danger'>Return Within 7 days</span>
    ...
    <h3><span className='text-danger'>Product ID</span>: 99237</h3>
