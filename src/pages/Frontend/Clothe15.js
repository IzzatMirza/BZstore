...
export default function clothe15() {
  return (
    <>
    <div className='container '>
  <div className='row'>
<div className='rounded col-12 col-md-6 col-sm-6 mt-3'>
<img src='c15i2.jpg' className='responsive'></img>
</div>


{/* <div className='rounded col-12 col-md-6 col-sm-6 mt-3'>
<img src='c15i3.jpg' className='responsive'></img>
...
•  Dupatta Pattern: Cut Work
  ...
  <li><span className='text-danger'>Return Within 7 days</span>
    ...
    <h3><span className='text-danger'>Product ID</span>: 99215</h3>
