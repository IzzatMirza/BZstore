...
<img src='c6i2.jpg' className='responsive'></img>
</div>


<div className='rounded col-12 col-md-6 col-sm-6 mt-3'>
<img src='c6i3.jpg' className='responsive'></img>
...
Shirt Fabric: Cotton Lawn
  ...
  {/* Product Code: MZ66900000577HS */}

  <li><span className='text-danger'>Return Within 7 days</span>
                    
                    </li>
                  
    <h3><span className='text-danger'>Product ID</span>: 99206</h3>
