...
<img src='ss5i3.jpg' className='responsive'></img>
</div> */}


<div className='rounded col-12 col-md-6 col-sm-6 mt-3'>
<img src='ss5i1.jpg' className='responsive'></img>
...
<li>
Product Feature: Lightweight, Casual
</li>
...
{/* Product Code: MZ1167200002WKINSE */}
  ...
  <li><span className='text-danger'>Return Within 7 days</span>
    ...
    <h3><span className='text-danger'>Product ID</span>: 99305</h3>
