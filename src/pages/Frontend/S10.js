...
<img src='ss10i3.jpg' className='responsive'></img>
</div>


<div className='rounded col-12 col-md-6 col-sm-6 mt-3'>
<img src='ss10i2.jpg' className='responsive'></img>
...
<li>
Material: Memory Foam (for insoles)
...
{/* Product Code: MZ78400008JYWA */}
  ...
  <li><span className='text-danger'>Return Within 7 days</span>
    ...
    <h3><span className='text-danger'>Product ID</span>: 99310</h3>
