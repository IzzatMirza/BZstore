...
export default function clothe12() {
  return (
    <>
    <div className='container '>
  <div className='row'>
<div className='rounded col-12 col-md-6 col-sm-6 mt-3'>
<img src='c12i2.jpg' className='responsive'></img>
</div>


<div className='rounded col-12 col-md-6 col-sm-6 mt-3'>
<img src='c12i3.jpg' className='responsive'></img>
...
Shirt Fabric: Katan Silk
  ...
  <li>
  Package Includes: 1 x Lehenga, 1 x Choli,  1 x Potli, 1 x Dupatta
  ...
  <li>
  ehenga Length: 38 Inches
  </li>
  <li>
  Lehenga Flare: 150 Inches
  </li>

  <li>
  Lehenga Stuff: Shamose Silk
  </li>

  <li>
  Heavy Border Embroidery Dupatta
  </li>
  <li>
  Stuff Chiffon
</li>
...
{/* Product Code: MZ104420222FYCGHB */}

  <li><span className='text-danger'>Return Within 7 days</span>
                    
                    </li>
                  
    <h3><span className='text-danger'>Product ID</span>: 99212</h3>
