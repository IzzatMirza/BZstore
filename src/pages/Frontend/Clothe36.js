...
export default function clothe36() {
  return (
    <>
    <div className='container '>
  <div className='row'>
<div className='rounded col-12 col-md-6 col-sm-6 mt-3'>
<img src='c36i2.jpg' className='responsive'></img>
</div>


<div className='rounded col-12 col-md-6 col-sm-6 mt-3'>
<img src='c36i3.jpg' className='responsive'></img>

</div>

<div className='rounded col-12 col-md-6 col-sm-6 mt-3'>
<img src='c36i4.jpg' className='responsive'></img>
...
<li>
Fancy Handmade Khussa
</li>
<li>
Decorated with Golden Handwork
</li>
<li>
Perfect Traditional Look to your Outfit
</li>
<li>
Round-toe
</li>
...
{/* Product Code: MZ1280200002GKSE */}
  ...
  <li><span className='text-danger'>Return Within 7 days</span>
    ...
    <h3><span className='text-danger'>Product ID</span>: 99236</h3>
