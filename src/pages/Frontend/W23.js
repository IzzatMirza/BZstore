...
<img src='w23i2.jpg' className='responsive'></img>
</div>


<div className='rounded col-12 col-md-6 col-sm-6 mt-3'>
<img src='w23i3.jpg' className='responsive'></img>
...
<div className='container mt-3'>
  ...
  <li>
  Product Feature: Sleek And Stylish Design
  </li>
  <li>
  Color: White
  </li>

  {/* Product Code: MZ1119200473BYBR */}
  ...
  <li><span className='text-danger'>Return Within 7 days</span>
    ...
    <h3><span className='text-danger'>Product ID</span>: 99123</h3>
