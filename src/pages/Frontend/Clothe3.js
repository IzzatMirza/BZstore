...
export default function Clothe3() {
  return (
    <>
...
<div className='rounded col-12 col-md-6 col-sm-6 mt-3'>
<img src='c3i3.jpg' className='responsive'></img>
...
Shirt Fabric: Cotton Lawn
  ...
  <li><span className='text-danger'>Return Within 7 days</span>
    ...
    <h3><span className='text-danger'>Product ID</span>: 99203</h3>
