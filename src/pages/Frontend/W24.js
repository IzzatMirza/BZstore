...
<img src='w24i2.jpg' className='responsive'></img>
</div>


<div className='rounded col-12 col-md-6 col-sm-6 mt-3'>
<img src='w24i3.jpg' className='responsive'></img>


</div>

<div className='rounded col-12 col-md-6 col-sm-6 mt-3'>
<img src='w24i4.jpg' className='responsive'></img>
...
<div className='container mt-3'>
  ...
  <li>
  Product Feature: Long-Lasting Battery With Fast Charge, Advanced Noise Cancellation For Any Environment, Voice Assistant, AI Noise Cancellation
  ...
  <li>
  Battery Capacity: 222 mAh
  </li>
  <li>
  Standby Time: 333 Hours
  </li>
  ...
  <li><span className='text-danger'>Return Within 7 days</span>
    ...
    <h3><span className='text-danger'>Product ID</span>: 99124</h3>
