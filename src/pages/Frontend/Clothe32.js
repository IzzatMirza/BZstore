...
<img src='c32i2.jpg' className='responsive'></img>
</div>


<div className='rounded col-12 col-md-6 col-sm-6 mt-3'>
<img src='c32i3.jpg' className='responsive'></img>

</div>

<div className='rounded col-12 col-md-6 col-sm-6 mt-3'>
<img src='c32i4.jpg' className='responsive'></img>
...
<li>
Product Feature: Comfortable, Stylish
</li>
<li>
...
{/* Product Code: MZ821200003EASE */}
  ...
  <li><span className='text-danger'>Return Within 7 days</span>
    ...
    <h3><span className='text-danger'>Product ID</span>: 99232</h3>
