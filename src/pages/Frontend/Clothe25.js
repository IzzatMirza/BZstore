...
export default function clothe25() {
  return (
    <>
    <div className='container '>
  <div className='row'>
<div className='rounded col-12 col-md-6 col-sm-6 mt-3'>
<img src='c25i2.jpg' className='responsive'></img>
</div>


<div className='rounded col-12 col-md-6 col-sm-6 mt-3'>
<img src='c25i3.jpg' className='responsive'></img>

</div>


<div className='rounded col-12 col-md-6 col-sm-6 mt-3'>
<img src='c25i4.jpg' className='responsive'></img>
...
<li>
Shirt Cutting: 2.75 Yards
</li>
<li>
Trouser Cutting: 2.75 Yards
</li>
<li>
Dupatta Cutting: 2.75 Yards
</li>



{/* Product Code: MZ117620119SHKLFS */}
 ...
 <li><span className='text-danger'>Return Within 7 days</span>
    ...
    <h3><span className='text-danger'>Product ID</span>: 99225</h3>
