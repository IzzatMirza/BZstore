...
<img src='ss20i3.jpg' className='responsive'></img>
</div>


<div className='rounded col-12 col-md-6 col-sm-6 mt-3'>
<img src='ss20i2.jpg' className='responsive'></img>
...
<li>
Package Includes: 2 Pcs Micro Polyester Printed T-Shirt And Trouser

</li>

{/* Product Code: MZ106920004ABTR */}
  ...
  <li><span className='text-danger'>Return Within 7 days</span>
    ...
    <h3><span className='text-danger'>Product ID</span>: 99320</h3>
