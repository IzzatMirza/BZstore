...
export default function Shop21() {
  return (
    <>
    <div className='container '>
      <div className='row'>
    <div className='rounded col-12 col-md-6 col-sm-6 mt-3'>
    <img src='s21i2.jpg' className='responsive'></img>
    </div>
    
    
    <div className='rounded col-12 col-md-6 col-sm-6 mt-3'>
    <img src='s21i3.jpg' className='responsive'></img>
    
    </div>

    <div className='rounded col-12 col-md-6 col-sm-6 mt-3'>
    <img src='s21i4.jpg' className='responsive'></img>
  ...
  <li>
  Product Features: Transparency Mode For Hearing And Connecting With The World Around You, Three Sizes Of Soft, Tapered Silicone Tips For A Customizable Fit,
  ...
  <li>
  Battery Capacity Of Earbuds: 30 mAh
  </li>
  ...
  <li>
  Color: Green, Pink, White, Blue, Black
  </li>
  ...
  <li><span className='text-danger'>Return Within 7 days</span>
    ...
    <h3><span className='text-danger'>Product ID</span>: 99021</h3>
