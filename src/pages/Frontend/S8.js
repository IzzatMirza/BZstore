...
<img src='ss8i3.jpg' className='responsive'></img>
</div>


<div className='rounded col-12 col-md-6 col-sm-6 mt-3'>
<img src='ss8i2.jpg' className='responsive'></img>
...
{/* Product Code: MZ78400000019JYWA */}
  ...
  <li><span className='text-danger'>Return Within 7 days</span>
    ...
    <h3><span className='text-danger'>Product ID</span>: 99308</h3>
