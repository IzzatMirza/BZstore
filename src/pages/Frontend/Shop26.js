...
export default function Shop26() {
  return (
    <>
    <div className='container '>
      <div className='row'>
    <div className='rounded col-12 col-md-6 col-sm-6 mt-3'>
    <img src='s26i1.jpg' className='responsive'></img>
    </div>
  ...
  <li>
  Shirt Front Pattern: Mirror Work
  </li>
...
<li>
Masoori embose trouser  With hand bag
</li>


{/* Product Code: MZ1443200073LYBK */}

  <li><span className='text-danger'>Return Within 7 days</span>
                    
                    </li>
                  
    <h3><span className='text-danger'>Product ID</span>: 99026</h3>
