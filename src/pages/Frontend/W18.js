...
<img src='w18i2.jpg' className='responsive'></img>
</div>


<div className='rounded col-12 col-md-6 col-sm-6 mt-3'>
<img src='w18i3.jpg' className='responsive'></img>
...
<div className='container mt-3'>
  ...
  <li>
  Band Clasp Type: Push Button Clasp
  </li>
  <li>
  Style: Casual Dress Fashion Luxury Sport
  </li>
  ...
  <li><span className='text-danger'>Return Within 7 days</span>
    ...
    <h3><span className='text-danger'>Product ID</span>: 99118</h3>
